...
abstract class RoundDao {
    @Insert abstract suspend fun insertGame(game: GameEntity): Long

    @Insert abstract suspend fun insertHand(hand: HandEntity): Long
